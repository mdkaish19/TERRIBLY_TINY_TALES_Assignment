                  ...
                  <div className=" flex items-start justify-start xsm:flex-col">
                    <a href="/">
                      <img
                        ...
                        alt="Profile"
                        className="w-28 h-28 ml-8 md:ml-12 md:w-32 md:h-32 lg:ml-16 lg:w-36 lg:h-36 rounded-full object-cover object-center border-2 border-slate-500 mr-6 relative bottom-6 overflow-hidden xsm:hidden"
                      />
                    </a>
